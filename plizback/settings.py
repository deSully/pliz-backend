...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # Whitenoise pour static files en prod
...
CORS_ALLOWED_ORIGINS = [
    ...
    "https://plizmoney.com",  # Frontend production
    "https://www.plizmoney.com",
    "https://app.plizmoney.com",
]

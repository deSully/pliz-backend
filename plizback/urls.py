"""
URL configuration for plizback project.
...
schema_view = get_schema_view(
    openapi.Info(
        title="Plizback API",
        default_version='v1',
        description="API de gestion de transactions",
        terms_of_service="https://www.google.com/policies/terms/",
        contact=openapi.Contact(email="williams.stanley.desouza@octo.com"),
